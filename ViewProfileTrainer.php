        ...
        <div class="row">
         <div class="form-group"> 
            ...
            <div class="form-group">  
             ...
             <br><br>
             <div class="form-group">  
                 <label class="col-sm-2" for="PackageNumber">Package working in :  </label>
                 <label class="col-sm-2" ><?php echo $row['packageNo']; ?></label>
             </div>
             <br><br>
             <div class="form-group">  
                 <label class="col-sm-2" for="SessionTime">Session Time :   </label>
                 <label class="col-sm-2" ><?php echo 'From '.$row['TimeStartingShift'].':00 To '.$row['TimeEndingShift'].':00'; ?>  </label>
             </div>
             <br><br>
        </div>
