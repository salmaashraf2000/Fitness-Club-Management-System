      ...
      <form method="post" class="form-horizontal">
          <div class="row">
            ...
            <div class="form-group">  
             ...
             <br><br>
             <div class="form-group">  
                 <label class="col-sm-2" for="PackageNumber">Current package enrolling in :  </label>
                 <label class="col-sm-2" ><?php echo $row['packageNo']; ?></label>
             </div>
             <br><br>
             <div class="form-group">  
                 <label class="col-sm-2" for="SessionTime">Session Time :   </label>
                 <label class="col-sm-2" ><?php echo 'From '.$row['SessionStartTime'].':00 To '.$row['SessionEndTime'].':00'; ?> </label>
             </div>
             <br><br>
             <div class="form-group">  
                 <label class="col-sm-2" for="StartDate">Start Date : </label>
                 <label class="col-sm-2" ><?php echo $row['StartDate']; ?> </label>
             </div>
             <br><br>
             <div class="form-group">  
                 <label class="col-sm-2" for="EndDate">End Date :  </label>
                 <label class="col-sm-2" ><?php echo $row['EndDate']; ?> </label>
             </div>
             <br><br>
             <div class="form-group">  
                 <label class="col-sm-2" for="TrainerName">Trainer Name : </label>
                 <label class="col-sm-2" ></label><?php echo $row['firstname'].' '.$row['lastname']; ?></label>
             </div>
             <br><br>
          </div>
