    ...
    <div class="container">     
     <form method="post" action="">  
         ...
         <div class="form-group">  
             ...
             <div class="col-sm-4"> 
             <input type="tel" id="PhoneNumber" name="PhoneNumber" pattern="[0]{1}[1]{1}[0-9]{9}" required="true" placeholder="phone number" class="form-control" value="<?php echo $PhoneNumber;?>"><?php echo $PhoneErr;?>
             </div>
         </div>
         <br><br>
         <div class="form-group">   
             ...
             <div class="col-sm-4"> 
             <input type="number" name="Age" min="10" value="<?php echo $Age;?>" placeholder="enter age" required="true" class="form-control"><?php echo $AgeErr;?>
             </div>
         </div>
         <br><br>
